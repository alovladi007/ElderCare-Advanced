...
|---------|------|----------|-------------|
| React Client (Landing Page) | **7500** | ~~3000~~ | Main website & public pages |
| NestJS Backend | **7501** | ~~3001~~ | Primary API server |
| Next.js Frontend | **7502** | ~~3002~~ | Smart home dashboard |
...
- **API Documentation**: http://localhost:7501/api/docs
...
Access at: http://localhost:7502/admin/simulator
- Simulate falls, fires, gas leaks
- Test automation rules
- Monitor device events

### Health Monitoring
Access at: http://localhost:7500/monitoring/login
