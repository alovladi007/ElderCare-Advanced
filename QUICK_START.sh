...
echo "   Landing Page: http://localhost:24610"
echo "   API Docs:     http://localhost:24611/api/docs"
echo "   Smart Home:   http://localhost:24617"
echo "   Monitoring:   http://localhost:24613"
echo ""
