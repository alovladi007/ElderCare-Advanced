...
echo "   Landing Page: http://localhost:31610"
echo "   API Docs:     http://localhost:31611/api/docs"
echo "   Smart Home:   http://localhost:31617"
echo "   Monitoring:   http://localhost:31613"
echo ""
