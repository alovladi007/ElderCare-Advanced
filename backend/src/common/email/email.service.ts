...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <a href="${this.configService.get<string>('FRONTEND_URL') || 'http://localhost:31610'}/dashboard" class="button">
        Go to Dashboard
      </a>
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <a href="${this.configService.get<string>('FRONTEND_URL') || 'http://localhost:31610'}/bookings" class="button">
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      ${medicationList}
      <a href="${this.configService.get<string>('FRONTEND_URL') || 'http://localhost:31610'}/medications" class="button">
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <a href="${this.configService.get<string>('FRONTEND_URL') || 'http://localhost:31610'}/alerts" class="button">
        View Alert Details
      </a>
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <a href="${this.configService.get<string>('FRONTEND_URL') || 'http://localhost:31610'}/emergencies" class="button">
