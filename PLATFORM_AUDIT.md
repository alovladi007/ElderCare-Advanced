...
The app now boots from a clean clone. Ports were moved to a block verified free of collisions (`31610`/`31611`/`31612`).

| Service | URL | Status |
|---|---|---|
| Web app | `http://localhost:31610` | ✅ compiles, warnings only |
| REST API | `http://localhost:31611` | ✅ builds clean, 121 unit tests pass |
| API docs (Swagger) | `http://localhost:31611/api/docs` | ✅ (unauthenticated — see C8) |
| WebSocket | `ws://localhost:31612` | ✅ |
...
**Reproduced:**
```
$ curl http://localhost:31611/uploads/medical-records/phi-test-record.txt
